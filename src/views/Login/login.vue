      ...
      <div class="main">
        <a-spin :spinning="loading">
          <a-form layout="horizontal" :wrapper-col="{ span: 24 }">
            <a-tabs :tab-bar-style="{ textAlign: 'center', borderBottom: 'unset' }">
              <a-tab-pane key="1" tab="账号密码登录">
                ...
                <a-form-item v-bind="validateInfos.captcha">
                  <a-row>
                    <a-col :span="14">
                      <a-input v-model:value="login.captcha" :size="inputSize" placeholder="请输入验证码">
                        <template #prefix>
                          <smile-outlined :style="prefixStyle" />
                        </template>
                      </a-input>
                    </a-col>
                    <a-col :span="2" />
            ...
            <a-form-item>
              <a-button block :size="inputSize" type="primary" @click="onSubmit">登录</a-button>
            </a-form-item>
          </a-form>
        </a-spin>
      </div>
